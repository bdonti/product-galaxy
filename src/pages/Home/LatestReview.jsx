...
const LatestReview = ({ review }) => {
  return (
    <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg h-">
      <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-900 dark:bg-gray-50">
        <p className="relative px-6 py-1 text-lg italic text-center text-gray-100 dark:text-gray-800">
          <svg
            ...
            viewBox="0 0 512 512"
            fill="currentColor"
            className="w-8 h-8 text-cyan-400 dark:text-cyan-600"
          >
          ...
          <svg
            ...
            viewBox="0 0 512 512"
            fill="currentColor"
            className="absolute right-0 w-8 h-8 text-cyan-400 dark:text-cyan-600"
          >
      ...
      <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-cyan-400 dark:bg-cyan-600 text-gray-900 dark:text-gray-50">
        <img
        ...
        <p className="text-sm uppercase">{review.userEmail}</p>
      </div>
    </div>
  );
};
